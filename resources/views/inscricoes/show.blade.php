...
@section('title', $inscricao->nome)
@section('content')
<div id="inscricao-create-container" class="col-md-6 offset-md-1">
        ...
        <form>
            ...
            <div class="container">
                 <div class="row">
                  <div class="col-6">
                  <a href="/inscricao/{{$inscricao->id}}" type="submit" target="_blank" class="btn btn-outline-dark btn-lg">Imprimir Comprovante</a>
                 </div>
                 <div class="col-6">
                 <a href="/" type="submit" class="btn btn-outline-dark btn-lg">Pagina Inicial</a>
                 </div>
             </div>
         </div> 
        </form>
